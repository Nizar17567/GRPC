...
class Compte extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Compte', createEmptyInstance: create)
    ...
    ..a<$core.double>(2, _omitFieldNames ? '' : 'solde', $pb.PbFieldType.OD)
  ...
  @$pb.TagNumber(2)
  set solde($core.double v) { $_setDouble(1, v); }
  @$pb.TagNumber(2)
...
class UpdateCompteRequest extends $pb.GeneratedMessage {
  factory UpdateCompteRequest({
    $core.int? id,
    CompteRequest? compte,
  }) {
    final $result = create();
  ...
  UpdateCompteRequest._() : super();
  factory UpdateCompteRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UpdateCompteRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateCompteRequest', createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.O3)
    ..aOM<CompteRequest>(2, _omitFieldNames ? '' : 'compte', subBuilder: CompteRequest.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UpdateCompteRequest clone() => UpdateCompteRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateCompteRequest copyWith(void Function(UpdateCompteRequest) updates) => super.copyWith((message) => updates(message as UpdateCompteRequest)) as UpdateCompteRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UpdateCompteRequest create() => UpdateCompteRequest._();
  UpdateCompteRequest createEmptyInstance() => create();
  static $pb.PbList<UpdateCompteRequest> createRepeated() => $pb.PbList<UpdateCompteRequest>();
  @$core.pragma('dart2js:noInline')
  static UpdateCompteRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UpdateCompteRequest>(create);
  static UpdateCompteRequest? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  CompteRequest get compte => $_getN(1);
  @$pb.TagNumber(2)
  set compte(CompteRequest v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCompte() => $_has(1);
  @$pb.TagNumber(2)
  void clearCompte() => clearField(2);
  @$pb.TagNumber(2)
  CompteRequest ensureCompte() => $_ensure(1);
}

/// Réponse pour la mise à jour d'un compte
class UpdateCompteResponse extends $pb.GeneratedMessage {
  factory UpdateCompteResponse({
    Compte? compte,
  }) {
    final $result = create();
    if (compte != null) {
  ...
  UpdateCompteResponse._() : super();
  factory UpdateCompteResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UpdateCompteResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateCompteResponse', createEmptyInstance: create)
    ..aOM<Compte>(1, _omitFieldNames ? '' : 'compte', subBuilder: Compte.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UpdateCompteResponse clone() => UpdateCompteResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateCompteResponse copyWith(void Function(UpdateCompteResponse) updates) => super.copyWith((message) => updates(message as UpdateCompteResponse)) as UpdateCompteResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UpdateCompteResponse create() => UpdateCompteResponse._();
  UpdateCompteResponse createEmptyInstance() => create();
  static $pb.PbList<UpdateCompteResponse> createRepeated() => $pb.PbList<UpdateCompteResponse>();
  @$core.pragma('dart2js:noInline')
  static UpdateCompteResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UpdateCompteResponse>(create);
  static UpdateCompteResponse? _defaultInstance;
