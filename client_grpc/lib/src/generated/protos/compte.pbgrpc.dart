...
class CompteServiceClient extends $grpc.Client {
  ...
  static final _$updateCompte = $grpc.ClientMethod<$0.UpdateCompteRequest, $0.UpdateCompteResponse>(
      '/CompteService/UpdateCompte',
      ($0.UpdateCompteRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.UpdateCompteResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.UpdateCompteResponse> updateCompte($0.UpdateCompteRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateCompte, request, options: options);
  }
...
abstract class CompteServiceBase extends $grpc.Service {
  ...
  CompteServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.UpdateCompteRequest, $0.UpdateCompteResponse>(
        'UpdateCompte',
        updateCompte_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.UpdateCompteRequest.fromBuffer(value),
        ($0.UpdateCompteResponse value) => value.writeToBuffer()));
  ...
  $async.Future<$0.UpdateCompteResponse> updateCompte_Pre($grpc.ServiceCall call, $async.Future<$0.UpdateCompteRequest> request) async {
    return updateCompte(call, await request);
  }
  ...
  $async.Future<$0.UpdateCompteResponse> updateCompte($grpc.ServiceCall call, $0.UpdateCompteRequest request);
